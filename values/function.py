...
class BaseFunction(Value):
  ...
  def generate_new_context(self):
    ...
    new_context.symbol_table = S_Table.symbol_table.SymbolTable(new_context.parent.symbol_table)
    return new_context
...
class Function(BaseFunction):
    ...
    def copy(self):
        copy = Function(self.name, self.body_node, self.arg_names,should_return_null)
